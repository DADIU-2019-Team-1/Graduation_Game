...
public class Movement : MonoBehaviour
{
    ...
    void FixedUpdate() {
        if(touchStart) {
            ...
            stick.transform.position = Input.mousePosition /* Vector2.ClampMagnitude(Input.mousePosition, 1100) */;/* new Vector3(initTouchPos.x + direction.x, initTouchPos.z + direction.z) * -1; */
        }
        else {
